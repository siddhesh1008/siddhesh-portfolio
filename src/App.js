...
const PROJECTS = {
  en: [
    ...
    {
      id: "arm-sim",
      title: "Robotic Arm Simulation (Armold)",
      status: "IN PROGRESS",
      tags: ["ROS2 (Jazzy)", "RViz2", "MoveIt2", "Gazebo", "URDF / Xacro", "Linux"],
      description: "A ROS2 Jazzy simulation of a 6-joint robotic arm, built across two packages — arm_description for URDF/Xacro modeling and arm_bringup for launch and visualization. Includes an automated setup script that installs dependencies, builds the workspace, and launches RViz2 with interactive joint sliders.",
      highlights: ["3 of 6 joints implemented: waist, shoulder, elbow", "Automated setup & build pipeline (run_sim.sh)", "Wrist joints (J5/J6) and gripper in progress"],
      github: "https://github.com/siddhesh1008/robotic_arm_sim",
    },
    {
      id: "crcs",
      title: "CRCS — Centralized Robotic Control System",
      status: "IN PROGRESS",
      tags: ["FastAPI", "MQTT", "Ollama", "ROS2 (Humble)", "Docker", "Python"],
      description: "A framework to control multiple robots from a single mini PC using natural language — \"talk to your robots, CRCS handles the rest.\" A local LLM (Ollama, Llama 3.1 8B) parses plain-English commands into structured JSON, which a FastAPI orchestrator routes to robots over an MQTT message bus, with live multi-robot state tracked on a 2D web visualization over WebSockets.",
      highlights: ["Natural language → LLM → MQTT command pipeline", "Live 2D multi-robot visualization via WebSockets", "ROS2 Humble in Docker + Tailscale remote access"],
      github: "https://github.com/siddhesh1008/CRCS",
    },
  ],
  de: [
    {
    ...
    {
      id: "arm-sim",
      title: "Roboterarm-Simulation (Armold)",
      status: "IN BEARBEITUNG",
      tags: ["ROS2 (Jazzy)", "RViz2", "MoveIt2", "Gazebo", "URDF / Xacro", "Linux"],
      description: "Eine ROS2-Jazzy-Simulation eines 6-gelenkigen Roboterarms, aufgeteilt in zwei Pakete — arm_description für URDF/Xacro-Modellierung und arm_bringup für Launch-Dateien und Visualisierung. Enthält ein automatisiertes Setup-Skript, das Abhängigkeiten installiert, den Workspace baut und RViz2 mit interaktiven Gelenk-Slidern startet.",
      highlights: ["3 von 6 Gelenken implementiert: Hüfte, Schulter, Ellbogen", "Automatisierte Setup- & Build-Pipeline (run_sim.sh)", "Handgelenke (J5/J6) und Greifer in Arbeit"],
      github: "https://github.com/siddhesh1008/robotic_arm_sim",
    },
    {
      id: "crcs",
      title: "CRCS — Zentralisiertes Robotersteuerungssystem",
      status: "IN BEARBEITUNG",
      tags: ["FastAPI", "MQTT", "Ollama", "ROS2 (Humble)", "Docker", "Python"],
      description: "Ein Framework zur Steuerung mehrerer Roboter von einem einzigen Mini-PC aus natürlicher Sprache — \"sprich mit deinen Robotern, CRCS übernimmt den Rest\". Ein lokales LLM (Ollama, Llama 3.1 8B) wandelt Befehle in einfachem Englisch in strukturiertes JSON um, das ein FastAPI-Orchestrator über einen MQTT-Message-Bus an die Roboter weiterleitet — mit Live-Statusverfolgung mehrerer Roboter in einer 2D-Webvisualisierung über WebSockets.",
      highlights: ["Pipeline: natürliche Sprache → LLM → MQTT-Befehl", "Live-2D-Visualisierung mehrerer Roboter via WebSockets", "ROS2 Humble in Docker + Tailscale-Fernzugriff"],
      github: "https://github.com/siddhesh1008/CRCS",
    },
  ],
};
